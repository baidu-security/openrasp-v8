...
do
  curl -L -o $DIR/java_natives_$OS.tar.gz.download -z $DIR/java_natives_$OS.tar.gz https://github.com/baidu-security/openrasp-v8/releases/download/$TAG/java_natives_$OS.tar.gz
